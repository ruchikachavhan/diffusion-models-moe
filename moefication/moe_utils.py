...
# Reference for all functions in this file - https://github.com/thunlp/MoEfication/tree/main
...
class LayerSplit:
    ...
    def load_param(self):
        ...
        # For Stable diffusion model, only the last half of the weights are used for the gate
        # So, we only consider the last half of the weights for MOEfication
